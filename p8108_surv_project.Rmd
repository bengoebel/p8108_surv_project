...
```{r rsf fit and res, fig.height = 4, fig.width = 6}
set.seed(2023)
## Random Survival Forest
...
```{r rsf pred curve, fig.height = 3.5, fig.width = 5, fig.align = 'center'}
...
TM - do we need to include any of this above? I think we can remove
